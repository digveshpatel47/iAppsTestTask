...
import com.iapps.data.photo.local.DateConverters
...
fun PhotoModel.toPhotoEntity() = PhotoEntity(
    ...
    published = DateConverters().toLocalDateTime(published)
)
...
fun PhotoEntity.toPhotoModel() = PhotoModel(
    ...
    description = description,
    published = DateConverters().fromLocalDateTime(published)
)
